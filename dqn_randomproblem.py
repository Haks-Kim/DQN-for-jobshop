...
class DQNAgent:
    ...
    def _build_subproblem_model(self):
        ...
        concaenated = keras.layers.concatenate(output_list)
        out = Dense(self.action_size,activation='linear')(concaenated)
    ...
    def _submodel(self):
        # the submodel called by function _build_subproblem_model
